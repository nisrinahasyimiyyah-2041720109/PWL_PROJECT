...
Route::get('/data_pembelian/data', [PembelianControntroller::class, 'data'])->name('data_pembelian.data');
        Route::get('/data_pembelian/{id}/create', [PembelianControntroller::class, 'create'])->name('data_pembelian.create');
        Route::resource('/data_pembelian', PembelianControntroller::class)
            ->except('create');
